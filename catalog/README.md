...
| Renata | 141 | [Models and source documents](manufacturers/renata.md) |
...
Pending candidates are listed separately in the [review queue](../review/index.json). Components and patent publications are excluded from these battery counts.
